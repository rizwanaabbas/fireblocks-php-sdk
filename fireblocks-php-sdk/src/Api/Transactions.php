...
class Transactions
{
    ...
    private function buildPayload(TransactionRequest $request): array
    {
        ...
        if ($request->travelRuleMessage !== null) {
            $payload['travelRuleMessage'] = $request->travelRuleMessage;
        }
    ...
    /**
     * Validate a Travel Rule transaction message before sending.
     * POST /v1/screening/travel_rule/transaction/validate
     */
    public function validateTravelRule(array $message): array
    {
        return $this->client->post('/v1/screening/travel_rule/transaction/validate', $message);
    }
