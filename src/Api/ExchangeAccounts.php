...
class ExchangeAccounts
{
    ...
    {
        return $this->client->get('/v1/exchange_accounts');
    }
    public function get(string $exchangeAccountId): array
    {
        return $this->client->get("/v1/exchange_accounts/{$exchangeAccountId}");
    }
    public function getAsset(string $exchangeAccountId, string $assetId): array
    {
        return $this->client->get("/v1/exchange_accounts/{$exchangeAccountId}/{$assetId}");
    }
